//This program finds a way to call hasOwnProperty on an object that has a property of that name. 
/*Exercise outline:
...
let test = {hasOwnProperty: 'hasOwnProperty', jules: true, apples: 3};
console.log(hasOwnProperty.call(test, 'jules'));